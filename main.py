...
def main(args):
    ...
    for i in range(0, 100000):
        ...
        if _score > -1:
            ...
            _subscore = simulate(a1, a2, a3, nums)[0]
            if _subscore > -1:
                _ratio = 1.0

                if _score > 0:
                    _ratio = 1.0 - (_subscore / _score)

                if _ratio < ratio:
                    ratio = _ratio
                    print("New Record!", "; P1:", a1, "; P2:", a2, "; P3:", a3, "; Numbers:", nums, "; Lucky:", str(int(round(1.0 - ratio, 2) * 100)), "; S1:", _score, "; S2:", _subscore)
